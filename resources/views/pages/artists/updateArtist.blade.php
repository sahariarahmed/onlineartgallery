...
@csrf
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input name="fname" type="text" class="form-control" id="inputFirstName" value="{{$artist->fname}}" placeholder="First Name" required>
    </div>
    <div class="form-group col-md-6">
      <label for="inputLastName">Last Name</label>
      <input name="lname" type="text" class="form-control" id="inputLastName" value="{{$artist->lname}}" placeholder="Last Name" required>
    </div>
  </div>

    <div class="form-group">
    <label for="inputEmail4">Email</label>
    <input name="email" type="email" class="form-control" id="inputEmail4" value="{{$artist->email}}" placeholder="Email" required>
    </div>
